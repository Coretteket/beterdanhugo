var msgs = {
    1: {
        ...
        "btn": [
            ["&raquo; Volgende.", "next(2);setDate(2020, 1, 6)"]
        ]
    },
    2: {
        ...
        "btn": [
            ["&raquo; Volgende.", "next(3);setDate(2020, 1, 10)"]
        ]
    },
    3: {
        ...
        "btn": [
            ["&raquo; Nee, het is al te druk.", "next(5);setDate(2020,1,11);"],
            ["&raquo; Ja, het is ook belangrijk.", "next(4);"]
        ]
    },
    4: {
        ...
        "btn": [
            ["&raquo; Een waarschuwing over de ziekte is nodig.", "next(5);setDate(2020,1,11);setMeasure('warningWuhan',true);"],
            ["&raquo; Het is nog te vroeg voor een waarschuwing.", "next(5);setDate(2020,1,11)"]
        ]
    },
    5: {
        ...
        "btn": [
            ["&raquo; Volgende.", "if(getMeasure('warningWuhan')){next(6);setDate(2020,1,13)}else{next(7);setDate(2020,1,14)};"]
        ]
    },
    6: {
        ...
        "btn": [
            ["&raquo; Volgende.", "next(7);setDate(2020,1,14);"]
        ]
    },
    7: {
...
function next(id) {
    ...
    for (var i = 0; i < msgs[id]["btn"].length; i++) {
        buttons = buttons + '<button class="btn btn' + id + '" onclick="' + msgs[id]["btn"][i][1] + '">' + msgs[id]["btn"][i][0] + '</button>';
    }
