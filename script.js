var msgs = {
    ...
    7: {
        "txt": "<p><b>WHO says new Chinese virus could spread, warns hospitals worldwide (Reuters)</b></p><p>There may have been limited human-to-human transmission of a new virus in China within families, and it is possible there could be a wider outbreak, the WHO warned on Tuesday. This comes after a Chinese woman was quarantined in Thailand with a mystery strain of coronavirus, the first time the virus has been detected outside China. The WHO is preparing for the possibility that there could be a wider outbreak, the acting head of WHO’s emerging diseases unit told a Geneva news briefing. “It is still early days, we don’t have a clear clinical picture.”</p>",
        "btn": [
            ["Volgende.", "next(8);setDate(2020,1,15);"]
        ]
    },
    8: {
        "txt": "<p>Na afloop van een werkbezoek aan het Martini Ziekenhuis heeft een journalist een vraag over het nieuwe virus. “Minister $NAME, in een persconferentie waarschuwde de Wereldgezondheidsorganisatie gisteren alle ziekenhuizen wereldwijd voor het 2019-nCoV virus. Moeten we ons zorgen maken over een nieuwe epidemie?”</p>",
        "btn": [
